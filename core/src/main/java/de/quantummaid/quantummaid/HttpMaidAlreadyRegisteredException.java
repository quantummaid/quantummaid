...
public final class HttpMaidAlreadyRegisteredException extends RuntimeException {
    ...
    private HttpMaidAlreadyRegisteredException(final String message) {
        super(message);
    }

    public static HttpMaidAlreadyRegisteredException httpMaidAlreadyRegisteredException() {
        final String message = "HttpMaid instance has already been registered to a QuantumMaid instance. " +
                "It cannot be registered to more than one QuantumMaid instance.";
        return new HttpMaidAlreadyRegisteredException(message);
    }
}
